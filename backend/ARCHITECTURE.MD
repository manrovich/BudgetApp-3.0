...
## 10. Codestyle
Логгеры добавляем только через аннотацию @Slf4j
При добавлении аннотаций самые важные остаются сверху (например, сначала @Entity/@Component, потом @Getters/@AllArgsConstructor)
